...
#edui110_content,#edui142_content,#edui155_content{height: auto !important;}
</style>
</head>
...
<div class="wrap J_check_wrap">
  <div class="nav">
    <ul class="cc">
      <li class="current"><a href="<?php echo U('products/add');?>">添加产品</a></li>
    </ul>
  </div>
  <form name="myform" id="myform" action="<?php echo u('products/add_post');?>" method="post" class="J_ajaxForms" enctype="multipart/form-data">
<!--
  <div class="col-right">
      ...
      <table width="100%">
            <tr>
              ...
              <td>
				...
				<?php if(is_array($suppliers)): foreach($suppliers as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo[id]==$supplier_id) {echo 'selected="selected"';} ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
				</select>
              </td>
            </tr>
            <tr>
              ...
              <td>
              	<input type="text" style="width:400px;" name="product_name" id="product_name" value="" style="color:" class="input input_hd J_title_color" placeholder="请输入产品名称" maxlength="80"/>
...
<!--临时位置-->
            <tr>
             ...
             <tr>
              ...
              <td><input type='text' name='keywords' id='keywords' value='' style='width:280px'   class='input' placeholder='请输入关键字'> 多关键词之间用半角逗号隔开</td>
            </tr>

            <tr>
              <th width="80">特性<span class="must_red">*</th>
              <td><textarea name='features' id='features' style='width:50%;height:150px;'  maxlength="660" ></textarea><br/>Product Features 建议不超过10行，此段文字将在产品介绍页的最顶端展示。最多勿超过660字符。</td>
            </tr>
<!--临时位置END-->
            <tr>
              <th width="80">产品型号<span class="must_red">*</th>
			  <input type="hidden" value="0" id="serial_no_f" />
              <td><input type='text' name='serial_no' id='serial_no' value='' style='width:280px' maxlength="25"  class='input' placeholder='请输入型号'></td>
            </tr>
            ...
            <tr>
              ...
              <td><textarea name='abstract' id='abstract' style='width:50%;height:100px;'  maxlength="160"></textarea><br/> Short Description 建议不超过160字符。此段将在产品列表页的摘要中展示，同时供搜索引擎收录用。可以写产品简介或参数。 </td>
            </tr>
            ...
            <tr>
              ...
              <td>
				...
				<div class="bk10"></div>
				<a href='javascript:void(0);' onclick="javascript:flashupload('albums_images', '图片上传','photos',change_images,'10,jpg|jpeg|png|bmp,0','','','')" class="btn">选择图片 </a> 请选择JPG/JPEG格式的图片，系统只支持这种格式的图片缩略功能</td>
            </tr>

            <tr>
              <th width="80">Data Sheet</th>
              <td>
			<input type='hidden' name='attachment' id='thumb' value=''>
			<input type="text" id="thumb_preview" />
            ...
            <input type="button"  class="btn" onclick="$('#thumb').val('');$('#thumb_preview').val('');return false;" value="取消附件">&nbsp;&nbsp;<font color="red">建议上传PDF文档，大小不超过20MB(只能上传一个附件)</font>
			  </td>
            </tr>
...
<!--
        <tr>
          <th width="80">发布时间</th>
          <td><input type="text" name="post_time" id="updatetime" value="<?php echo date('Y-m-d H:i:s',time());?>" size="21" class="input length_3 J_datetime "></td>
        </tr>
-->
	...
	/////---------------------
	 Wind.use('validate', 'ajaxForm', 'artDialog', function () {
			//javascript
	            ...
	            jQuery.validator.addMethod('categorys_check',function(v,e,p){
//					console.log(v>0);
					console.log($('#value_category option').length);
					return $('#value_category option').length>0;
//					return v>0;
	            });
	        ...
	        form.validate({
	            ...
	            rules: {
					...
					'categorys[]':{categorys_check:true},
	            ...
	            messages: {
					...
					'categorys[]':{categorys_check:'请选择分类'},
