	...
	$(document).ready(function(){
		Wind.use("swfupload",GV.DIMAUB+"statics/js/swfupload/handlers.js",function(){
			...
			post_params:{
			                        ...
			                        "thumb_height":"0",
			                        "watermark_enable":"1",
			                        "filetype_post":"jpg|jpeg|gif|png|bmp|pdf",
			                        "swf_auth_key":"6d13c3d7ccf4d88a35d41f5d9fea0aed"
			},
			file_size_limit:"20240KB",
			file_types:"*.jpg;*.jpeg;*.gif;*.png;*.bmp;*.pdf",
    ...
    <div class="pop_cont">
      <div class="">
        <div class="edit_uping"> 
            ...
            <span class="num"><!-- <input type="checkbox" id="watermark_enable" value="1" checked  onclick="change_params()"><em>是否添加水印</em> --> 最多上传<em> 1</em> 个附件,单文件最大 <em>20 MB</em>，<em style="cursor: help;" title="可上传格式：jpg,jpeg,gif,png,bmp">支持格式？</em></span>
        </div>
